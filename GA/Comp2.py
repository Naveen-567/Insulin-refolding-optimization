...
def evaluation(pop,DF_o, Conc_o):
    ...
    for i in range(pop.shape[0]):
        ...
        DF = DF_o
        Conc = Conc_o
        obj1 = 48.714+(2.166*(pH-10))+((-1)*((Temp-14)/10))+((pH-10)*((Temp-14)/10)*(-0.25))+((pH-10)*(pH-10)*(-2.928))+(((Temp-14)/10)*((Temp-14)/10)*(-3.428))
        obj2 = 54.642+(2.666*(pH-10))+((-0.833)*((Temp-14)/10))+((pH-10)*((Temp-14)/10)*(-0.5))+((pH-10)*(pH-10)*(-2.785))+(((Temp-14)/10)*((Temp-14)/10)*(-4.285))
        obj3 = 67.214+(2.333*(pH-10))+((-1.333)*((Temp-40)/10))+((pH-10)*((Temp-14)/10)*(-0.25))+((pH-10)*(pH-10)*(-5.928))+(((Temp-14)/10)*((Temp-14)/10)*(-3.928))
        obj4 = 59.12 + (20.033*((pH-9.5)/1.5)) + (1.311*((Conc-50)/25))+ ((-1.367)*((Temp-9.5)/1.5)) + ((-0.133)*((DF-20)/10)) + (((pH-9.5)/1.5)*((Conc-50)/25)*(0.35))+ (((pH-9.5)/1.5)*((Temp-14)/10)*(0.275))+ (((Conc-50)/25)*((Temp-14)/10)*(0.9))+ (((pH-9.5)/1.5)*((DF-20)/10)*(0.15))+ (((Conc-50)/25)*((DF-20)/10)*(0.525))+ (((Temp-14)/10)*((DF-20)/10)*(1.4))+ (((pH-9.5)/1.5)*((pH-9.5)/1.5)*(-18.993))+ (((Conc-50)/25)*((Conc-50)/25)*(-2.493))+ (((Temp-14)/10)*((Temp-14)/10)*(0.007))+ (((DF-20)/10)*((DF-20)/10)*(-0.493))
